...
export function createApp() {
  ...
  app.post('/items', (req, res) => {
    ...
    // Limpiar o invalidar la caché de la lista general
    cache.clear();
  ...
  app.patch('/items/:id', (req, res) => {
    ...
    // Invalidar la clave de caché del elemento actualizado y de la lista general
    cache.delete(`item_${idParam}`);
    cache.clear();
